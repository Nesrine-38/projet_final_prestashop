...
{if isset($products) && $products}
	...
	{foreach from=$products item=product name=products}        
        {if isset($ybcDev) && $ybcDev && isset($tc_dev_mode) && $tc_dev_mode && isset($tc_layout_products) && $tc_layout_products && in_array($product.id_product,$tc_layout_products) || !isset($ybcDev) || isset($ybcDev) && !$ybcDev || !isset($tc_layout_products) || isset($tc_layout_products) && !$tc_layout_products}

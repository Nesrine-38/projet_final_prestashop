...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2')}
            <link rel="stylesheet" href="{$css_dir}/layout_2.css" type="text/css" media="all" />
        {elseif (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3')}
            <link rel="stylesheet" href="{$css_dir}/layout_3.css" type="text/css" media="all" />
        {/if}
	...
	{if !isset($content_only) || !$content_only}
		...
		<div id="page">
            {if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2'}
                {include file="$tpl_dir./sub/header/layout_2.tpl"}
            {elseif isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'}
                {include file="$tpl_dir./sub/header/layout_3.tpl"}
            {else}
    						...
    						<div class="container">
    							<div class="row">
                                    {if isset($tc_config.YBC_TC_FLOAT_HEADER) && $tc_config.YBC_TC_FLOAT_HEADER}
                                        <div class="ybc_custom_float_header">
                                            <div class="container">
                                                <div class="row">
                                    {/if}
        								<div id="header_logo">

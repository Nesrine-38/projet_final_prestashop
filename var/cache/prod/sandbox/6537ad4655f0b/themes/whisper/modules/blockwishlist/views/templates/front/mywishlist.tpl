...
<div id="mywishlist" class="animation">
	{capture name=path}
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box animation" id="form_wishlist">
			<fieldset>
		...
		{if $wishlists}
			<div id="block-history" class="block-center animation">
		...
		{/if}
	{/if}
	<ul class="footer_links clearfix animation">
		<li>

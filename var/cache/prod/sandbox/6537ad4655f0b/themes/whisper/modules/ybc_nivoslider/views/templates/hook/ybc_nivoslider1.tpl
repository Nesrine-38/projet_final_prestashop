...
<!-- Module ybc_nivoslider -->
    {if isset($homeslider_slides)}
        ...
        {/if} 
    		<div id="ybc-nivo-slider-wrapper" class="theme-default animated fadeInUp ybc_delay12">
            ...
            {if $slide.legend2}
                <p class="style_button" style="display:none" title="">{$slide.legend2|escape:'htmlall':'UTF-8'}</p>
            {/if}

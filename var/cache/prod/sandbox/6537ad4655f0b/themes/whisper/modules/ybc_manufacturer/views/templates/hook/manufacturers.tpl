    ...
    <div id="ybc-mnf-block">
        <div class="container">
            <div class="ybc-mnf-block-content">
                <h4 class="ybc-mnf-block-title title_block_home"><span class="title_cat">{$YBC_MF_TITLE}</span></h4>
                <ul id="ybc-mnf-block-ul" class="{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1}zoomIn wow {/if}">

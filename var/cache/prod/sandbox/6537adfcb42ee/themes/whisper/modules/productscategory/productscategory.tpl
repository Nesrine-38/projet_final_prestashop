...
<section class="page-product-box blockproductscategory">
	<h3 class="productscategory_h3 page-product-heading animation">
	...
	<div id="productscategory_list" class="clearfix row animation">
		<ul id="bxslider1" class="bxslider clearfix">
		{foreach from=$categoryProducts item='categoryProduct' name=categoryProduct}
			<li class="product-box item">
                <div class="product-box-content">
                    <div class="left-block animation">
                        ...
                        <div class="button-container">
                            ...
                            {if isset($comparator_max_item) && $comparator_max_item}
    							<div data-id-product="{$categoryProduct.id_product}" class="add_to_compare compare" data-toggle="tooltip" data-placement="left" title="{l s='Add to Compare' mod='productscategory'}">
            				...
            				<div data-toggle="tooltip" data-placement="left" title="{l s='Add to cart' mod='productscategory'}" class="ybc_add_to_cart" style="margin-top:5px">
                ...
                <div class="right-block animation">

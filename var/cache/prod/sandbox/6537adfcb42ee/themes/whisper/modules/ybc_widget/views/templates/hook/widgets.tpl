{if $widgets}
    {if $widget_hook == "display-top-column" }
        {if $page_name == "index"}
            <div class="home_widget_top_column{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'} home_top_colum_layout3 col-sm-6 col-xs-12{/if}">
                <div class="container">
                    <ul class="ybc-widget-{$widget_hook} row">
                        {foreach from=$widgets item='widget'}
                            <li class="{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1}zoomIn wow {/if}ybc-widget-item{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2')} ybc-widget-item-layout-2{elseif ($tc_config.YBC_TC_LAYOUT == 'LAYOUT3')} ybc-widget-item-layout-3{/if}">
    ...
    {else if $widget_hook == "ybc-custom-2"}
        <ul class="ybc-widget-{$widget_hook}">                
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item col-xs-4 {if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1}zoomIn wow {/if}">
                        <div class="ybc-widget-item-content">
    ...
    {else}
        <ul class="ybc-widget-{$widget_hook}">
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item {if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1}zoomIn wow {/if}">
                        {if $widget.icon}<i class="fa {$widget.icon}"></i>{/if}
                        {if $widget.show_image && $widget.image}{if $widget.link}<a href="{$widget.link}">{/if}<img src="{$widget_module_path}images/widget/{$widget.image}" alt="{$widget.title}" />{if $widget.link}</a>{/if}{/if}
                        {if $widget.show_title && $widget.title}<h4 class="ybc-widget-title">{if $widget.link}<a href="{$widget.link}">{/if}{$widget.title}{if $widget.link}</a>{/if}</h4>{/if}

	...
	<div class="primary_block row product_layout_1">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			...
			<div id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
    			...
    			<form id="buy_block" class="{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} hidden{/if}" action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
    				<!-- hidden datas -->
    				<p class="hidden">
    ...
    <div id="tab_product_page">
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            {if isset($accessories) && $accessories}
                <li role="presentation">
                    <a href="#product_accessories" aria-controls="product_accessories" role="tab" data-toggle="tab">

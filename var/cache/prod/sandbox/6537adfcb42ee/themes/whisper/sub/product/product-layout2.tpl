...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row product_layout_2">
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-5">
			<!-- product img-->
			<div id="image-block" class="clearfix{if !$content_only} animation{/if}">
				{if $product->new}
					<span class="new-box">
			...
			{if isset($images) && count($images) > 0}
				<!-- thumbnails -->
				<div id="views_block" class="{if !$content_only}animation {/if}clearfix {if isset($images) && count($images) < 2}hidden{/if}">
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column col-xs-12 col-sm-7{if !$content_only} animation{/if}">
			{if $product->online_only}
				<p class="online_only">{l s='Online only'}</p>
			{/if}
			<h1 {if !$content_only}class="animation"{/if} itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
            <ul class="top_review_product animation">
                {if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT}{$HOOK_EXTRA_RIGHT}{/if}
            </ul>
            
            <p {if !$content_only}class="animation"{/if} id="availability_statut"{if !$PS_STOCK_MANAGEMENT || ($product->quantity <= 0 && !$product->available_later && $allow_oosp) || ($product->quantity > 0 && !$product->available_now) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
            ...
            {if isset($tc_config.YBC_TC_PRODUCT_REF) && $tc_config.YBC_TC_PRODUCT_REF}
                <p {if !$content_only}class="animation"{/if} id="product_reference"{if empty($product->reference) || !$product->reference} style="display: none;"{/if}>
            ...
            {if isset($tc_config.YBC_TC_CONDITION) && $tc_config.YBC_TC_CONDITION}
    			{if !$product->is_virtual && $product->condition}
        			<p id="product_condition" {if !$content_only}class="animation"{/if}>
            ...
            <div class="content_prices clearfix{if !$content_only} animation{/if}">
			...
			{if $product->description_short || $packItems|@count > 0}
				<div id="short_description_block" {if !$content_only}class="animation"{/if}>
			...
			{if $PS_STOCK_MANAGEMENT}
				...
				<p class="warning_inline{if !$content_only} animation{/if}" id="last_quantities"{if ($product->quantity > $last_qties || $product->quantity <= 0) || $allow_oosp || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none"{/if} >{l s='Warning: Last items in stock!'}</p>
			{/if}
			<p {if !$content_only}class="animation"{/if} id="availability_date"{if ($product->quantity > 0) || !$product->available_for_order || $PS_CATALOG_MODE || !isset($product->available_date) || $product->available_date < $smarty.now|date_format:'%Y-%m-%d'} style="display: none;"{/if}>
			...
			<div id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
    			...
    			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
    				...
    				<div class="box-info-product">
    					...
    					<div class="product_attributes clearfix{if !$content_only} animation{/if}">
    						<!-- quantity wanted -->
                            ...
                            {if isset($tc_config.YBC_TC_PRODUCT_QTY) && $tc_config.YBC_TC_PRODUCT_QTY}
                                {if !$PS_CATALOG_MODE}
            						<p {if !$content_only}class="animation"{/if} id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
    					...
    					<div class="box-cart-bottom{if !$content_only} animation{/if}">
                ...
                {if !$content_only}
                    {if ((isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS) || ($HOOK_EXTRA_LEFT) || (isset($tc_config.YBC_TC_USEFUL_LINK) && $tc_config.YBC_TC_USEFUL_LINK) )}
                        <ul class="box-sharing-button animation">
                    ...
                    {if ((isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT) || (isset($tc_config.YBC_TC_SOCIAL_SHARING) && $tc_config.YBC_TC_SOCIAL_SHARING))}
                        <ul id="usefull_link_block" class="animation socialsharing_product list-inline" style="text-align: center">
    ...
    <div id="tab_product_page">
          ...
          <ul class="nav nav-tabs animation" role="tablist">
            ...
            {if isset($attachments) && $attachments}
                <li role="presentation">
                    <a href="#product_download" aria-controls="product_download" role="tab" data-toggle="tab">
            ...
            {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
                <li role="presentation">
                    <a href="#product_discount" aria-controls="product_discount" role="tab" data-toggle="tab">
          ...
          <!-- Tab panes -->
          <div class="tab-content animation">
                {if isset($product) && $product->description}
        			<!-- More info -->
        			<section class="page-product-box tab-pane active" id="product_description">
                        <h2 style="display:none">{l s='product description'}</h2>
        				<!-- full description -->
                ...
                {if isset($features) && $features}
                    ...
                    <h2 style="display:none">{l s='product featured'}</h2>
                ...
                {if isset($attachments) && $attachments}
    			     <!--Download -->
        			<section class="page-product-box tab-pane" id="product_download">
                    <h2 style="display:none">{l s='product download'}</h2>
                ...
                {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
        			<!-- quantity discount -->
        			<section class="page-product-box tab-pane" id="product_discount">
                    <h2 style="display:none">{l s='product discount'}</h2>
		...
		<section id="blockpack" class="animation">
		...
		{if isset($accessories) && $accessories}
			<!--Accessories -->
        			<section class="page-product-box animation" id="product_accessories">
                        <h2 style="display: none">{l s='accessories'}</h2>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<!--Customization -->
			<section class="page-product-box animation">
